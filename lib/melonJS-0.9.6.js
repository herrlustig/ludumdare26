...
(function($) {
	...
	me.Viewport = me.Rect
			...
			/** @scope me.Viewport.prototype */
			{
				...
				fadeOut : function(color, alpha, duration, onComplete) {
					this._fadeOut.color = color;
					this._fadeOut.duration = duration || 1000; // convert to ms
					this._fadeOut.alpha = alpha || 1.0;
...
(function($) {
	...
	me.audio = (function() {
		...
		function _play_audio_enable(sound_id, loop, callback, volume, panning) {
			...
			// console.debug("soundclip:", soundclip);
			soundclip.play();
